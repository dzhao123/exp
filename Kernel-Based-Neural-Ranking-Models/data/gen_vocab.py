...
f = open('/work/ececis_research/Manning/top1000.dev.tsv')
for line in f:
    line = line.strip('\n').split('\t')
    accumulate(line[2], word_dic)
...
#idx = 1
#fout = open('/work/ececis_research/Manning/vocab_gen.tsv', 'w')
...
idx = 1
fout = open('/work/ececis_research/Manning/vocab_bert_gen.tsv', 'w')
for word in word_dic:
    if word_dic[word] >= 1:
       fout.write(word + '\t' + str(idx) + '\n')
       idx += 1
